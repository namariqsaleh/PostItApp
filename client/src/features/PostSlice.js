...
export const getPosts=createAsyncThunk("posts/getPosts",async()=>{
    try{
        const response=await axios.get("https://postitapp-gegh.onrender.com/getPosts");
...
export const savePost=createAsyncThunk("posts/savePost",async(pdata)=>{
    try{
        const response=await axios.post("http://https://postitapp-gegh.onrender.com/savePost",pdata);
...
export const updatePost=createAsyncThunk("posts/updatePost",async(pdata)=>{
    try{
        const response=await axios.put("http://https://postitapp-gegh.onrender.com/updatePost",pdata);
...
export const delPost=createAsyncThunk("posts/delPost",async(pid)=>{
    try{
        const response=await axios.delete(`http://https://postitapp-gegh.onrender.com/delPost/${pid}`);
        return response.data;
    }
    catch(error){
        console.log(error);
